...
static struct snd_soc_dapm_widget tfa98xx_dapm_widgets_common[] __maybe_unused = {
	/* Stream widgets */
	SND_SOC_DAPM_AIF_IN("AIF IN", "AIF Playback", 0, SND_SOC_NOPM, 0, 0),
...
static struct snd_soc_dapm_widget tfa98xx_dapm_widgets_stereo[] __maybe_unused = {
	SND_SOC_DAPM_OUTPUT("OUTR"),
};

static struct snd_soc_dapm_widget tfa98xx_dapm_widgets_saam[] __maybe_unused = {
	SND_SOC_DAPM_INPUT("SAAM MIC"),
};

static struct snd_soc_dapm_widget tfa9888_dapm_inputs[] __maybe_unused = {
