...
static int tri_key_m1120_i2c_drv_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    pr_info("%s: reset and init device\n", __func__);
    ...
    pr_info("%s: config work function\n", __func__);
    ...
    oneplus_register_hall("hall_m1120_down", &m1120_downs_ops);
